...
<? $cri->includeContent(1,'navNoMap'); ?>
<div class="fullContainer fullContainer--hero">
	<div class="content content__hero content__hero--info">
		<img src="http://placehold.it/500x200?text=Image+to+come" alt="Image to Come" class="content__hero">
	</div>
	<h1 class="heading">McGinnis Ferry</h1>
</div>
<div class="container">
	<div class="row">
