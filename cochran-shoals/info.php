	...
	<div class="row">
		<div class="content content--last">
			<div class="basicInfo">
				...
				<h2 class="subHeading">Difficulty: <br><span>Easy &ndash; Moderate &ndash; Difficult</span></h2>
			</div>
			<div class="amenities">
				<span class="hint--top" data-hint="Fitness Trail"><img src="../_images/_global/fitness.svg" alt="Fitness Trail"></span>
				<span class="hint--top" data-hint="Hiking Trails"><img src="../_images/_global/hiking.svg" alt="Hiking Trails"></span>
				<span class="hint--top" data-hint="Mountain Biking Trails"><img src="../_images/_global/biking.svg" alt="Mountain Biking Trails"></span>
